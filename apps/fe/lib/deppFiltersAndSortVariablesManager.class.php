...
class deppFiltersAndSortVariablesManager
{
  ...
  public static function resetVars($session, $type, $stored_name, $namespaces = array())
  {
    ...
    sfContext::getInstance()->getLogger()->info("xxx: actual_name:$actual_name:");
    sfContext::getInstance()->getLogger()->info("xxx: stored_act_mod:$stored_act_mod:");
    if ($actual_name != $stored_act_mod)
    {
      sfContext::getInstance()->getLogger()->info('xxx: will reset filters');
