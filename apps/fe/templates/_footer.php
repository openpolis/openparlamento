...
<ul>
  ...
  <!-- <li><a lang="it" href="">»&nbsp;dicono di noi</a></li> -->
   <li><?php echo link_to('»&nbsp;contatti','/static/contatti',array('lang'=>'it')) ?></li>
</ul>
...
<span style="margin-top: 100px;">
  ...
  <a href="http://indice.openpolis.it"><img src="http://associazione.openpolis.it/images/button_indice.png"  border=0 alt="logo di indice di produttività"></a>
