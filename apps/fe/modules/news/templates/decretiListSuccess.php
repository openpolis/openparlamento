...
<div class="row">
	<div class="ninecol">
		...
		<h4 class="subsection">Tutte le notizie relative ai decreti legge<?php echo link_to(image_tag('ico-rss.png', array('alt' => 'rss')), '@feed_decreti', array('style' => 'vertical-align:middle; padding:5px;')) ?></h4>
