...
<div class="row">
	<div class="ninecol">
		...
		<h4 class="subsection">Tutte le notizie relative ai disegni di legge<?php echo link_to(image_tag('ico-rss.png', array('alt' => 'RSS', 'width' => '32', 'height' => '13')), '@feed_disegni', array('style' => 'vertical-align:middle; padding:5px;')) ?></h4>
