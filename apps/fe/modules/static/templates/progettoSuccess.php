...
<div class="row">
	...
	<div class="threecol last">
		...
		<div style="font-size:14px; background-color:#efefef; padding:5px"><span style="padding:0 10px 0 0; "><?php echo image_tag('/images/start_quote_rb.gif') ?></span><i>Io mi auguro che i cittadini siano in condizione di sapere di pi&ugrave;, di intervenire di pi&ugrave; nei processi di decisione, senza con questo far perdere di senso le assemblee rappresentative</i><span style="padding:20px; "><?php echo image_tag('/images/end_quote_rb.gif',array('alt'=>'fine citazione')) ?></span>
	     <p style="text-align:right; font-size:12px;"><?php echo link_to('Stefano Rodot&agrave;','http://it.wikipedia.org/wiki/Stefano_Rodot%C3%A0') ?></p>
	    </div>
