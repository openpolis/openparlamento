	          ...
	          <?php $tr_class = ($tr_class == 'even' ? 'odd' : 'even' )  ?>
	            ...
	            <?php if ($parlamentari->getString(9)==NULL) :?>
	              <td><strong><?php echo link_to($parlamentari->getInt(5), 
	  				                     '@parlamentare_voti?id='.$parlamentari->getInt(2).'&slug='.$slugPolitico.'&filter_vote_rebel=3') ?></strong></td>
	              <td><strong><?php echo link_to($parlamentari->getInt(5)-$parlamentari->getInt(7),'@parlamentare_voti?id='.$parlamentari->getInt(2).'&slug='.$slugPolitico.'&filter_vote_rebel=3&filter_vote_vote=Presente') ?></strong></td>
	              <td><strong><?php echo link_to($parlamentari->getInt(7), 
	                        				'@parlamentare_voti?id='.$parlamentari->getInt(2).'&slug='.$slugPolitico.'&filter_vote_rebel=3&filter_vote_vote=Assente') ?></strong></td>
	            <?php else :?>            				            
