...
<div id="disegni-decreti-order" class="float-container tools-container">
  ...
  <ul>
    <li>
	  ...
	  <?php else: ?>
        <?php echo link_to('data voto', '@votazioni?sort=data&type=desc') ?>
      <?php endif; ?>
	</li>
	<li>
	  ...
	  <?php else: ?>
        <?php echo link_to('voti di scarto', '@votazioni?sort=margine&type=desc') ?>
      <?php endif; ?>
	</li>
   <li>
	  ...
	  <?php else: ?>
        <?php echo link_to('numero di ribelli', '@votazioni?sort=ribelli&type=desc') ?>
      <?php endif; ?>
	</li>
  </ul>
</div>