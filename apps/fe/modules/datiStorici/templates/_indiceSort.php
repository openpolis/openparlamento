  ...
  <ul>
    ...
    <li>
      <?php if ($sf_user->getAttribute('sort', null, 'sf_admin/opp_storici/sort') == 'indice'): ?>
        <?php echo link_to('indice', 'datiStorici/indice?sort=indice&type='.($sf_user->getAttribute('type', 'asc', 'sf_admin/opp_storici/sort') == 'asc' ? 'desc' : 'asc'), array('class' => 'current '.$current_class)) ?>
      <?php else: ?>
        <?php echo link_to('indice', 'datiStorici/indice?sort=indice&type=desc') ?>
      <?php endif; ?>
    </li>
  </ul>
</div>