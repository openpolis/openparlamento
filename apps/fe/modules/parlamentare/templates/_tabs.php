<ul id="content-tabs" class="float-container tools-container">
    ...
    <li class="<?php echo($ramo=='camera' && $organi ? 'current' : '' ) ?>">
      <h6><?php echo link_to('Organi della Camera '.image_tag('/images/ico-new.png'), '@organi?ramo=camera') ?></h6>   
    </li>
    ...
    <li class="<?php echo($ramo==2 && $gruppi ? 'current' : '' ) ?>">
      ...
      <li class="<?php echo($ramo=='senato' && $organi ? 'current' : '' ) ?>">
        <h6><?php echo link_to('Organi del Senato '.image_tag('/images/ico-new.png'), '@organi?ramo=senato') ?></h6>   
      </li>  
    </li>
