...
<div class="W45_100 float-left">
  ...
  <div class="W45_100 float-left">
    <div class="float-container">
      ...
      <?php echo link_to($parlamentare1->getOppPolitico()->getNome().' '.$parlamentare1->getOppPolitico()->getCognome(),'@parlamentare?'.$parlamentare1->getOppPolitico()->getUrlParams()).
       ' e '. link_to($parlamentare2->getOppPolitico()->getNome().' '.$parlamentare2->getOppPolitico()->getCognome(),'@parlamentare?'.$parlamentare2->getOppPolitico()->getUrlParams()) ?>
