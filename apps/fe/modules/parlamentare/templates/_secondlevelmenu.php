<?php $tecnico = isset($tecnico) ? $tecnico : false; ?>
<div class="float-container">
    ...
    <li class="<?php echo($current=='atti' ? 'current' : '' ) ?>">
          <h5>
          <?php echo link_to('I suoi atti', $current=='atti'?'#':'@parlamentare_atti?id='.$parlamentare_id .'&slug='. $parlamentare_slug) ?>
          </h5>
        </li>    
    ...
    <li class="<?php echo($current=='voti' ? 'current' : '' ) ?>">
          <h5>
          <?php echo link_to('I suoi voti', $current=='voti'?'#':'@parlamentare_voti?id='.$parlamentare_id .'&slug='. $parlamentare_slug) ?>
          </h5>
        </li>
    <li class="<?php echo($current=='interventi' ? 'current' : '' ) ?>">
          <h5>
          <?php echo link_to('I suoi interventi', $current=='interventi'?'#':'@parlamentare_interventi?id='.$parlamentare_id .'&slug='. $parlamentare_slug) ?>
         </h5>
        </li>
    </ul>
</div>
