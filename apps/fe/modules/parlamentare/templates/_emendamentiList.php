...
<table class="disegni-decreti column-table">
  <thead>
    <tr> 
      ...
      <th scope="col">ddl cui si riferisce:</th>
  ...
  <tbody>
  <?php $tr_class = 'even' ?>		
    <?php foreach ($pager->getResults() as $carica_has_em): ?>
      <?php $em = $carica_has_em->getOppEmendamento(); ?>
      <tr class="<?php echo $tr_class; ?>">
       <?php $tr_class = ($tr_class == 'even' ? 'odd' : 'even' )  ?> 
        <td><p><?php echo $carica_has_em->getTipo() ?></p></td>
        <th scope="row">
        ...
        <td>
           <?php $ddls=$em->getOppAttoHasEmendamentos() ?>
            
            <p><?php echo link_to($ddls[0]->getOppAtto()->getRamo().'.'.$ddls[0]->getOppAtto()->getNumfase(), '/singolo_atto/'.$ddls[0]->getOppAtto()->getId()) ?></p>
        ...
        <td>
          <div class="user-stats-column">
            ...
            <p><?php echo link_to($em->getNbCommenti().' <strong>commenti</strong>', '#') ?></p>
          </div>
        </td>	
      </tr>
    <?php endforeach; ?>
