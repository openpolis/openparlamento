<?php if (count($pro_acts)>0 || count($anti_acts)>0): ?>
  <div class="pink-vanity">	
  	...
  	<h5 class="subsection">Gli utenti favorevoli a questo atto...</h5>

    <?php if (count($pro_acts)>0): ?>
    	<h5 class="subsection-spec">...sono favorevoli anche a:</h5>
    ...
    <?php if (count($anti_acts)>0): ?>
    	<h5 class="subsection-spec">...sono contrari a:</h5>
    	<div class="topics float-container">
