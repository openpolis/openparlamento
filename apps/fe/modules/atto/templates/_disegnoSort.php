...
<div id="disegni-decreti-order" class="float-container tools-container">
  ...
  <ul>
    <li>
      ...
      <?php else: ?>
        <?php echo link_to('data presentazione', 'atto/disegnoList?sort=data_pres&type=desc') ?>
      <?php endif; ?>
    </li>
    <li>
      <?php if ($sf_user->getAttribute('sort', null, 'sf_admin/opp_atto/sort') == 'stato_last_date'): ?>
        <?php echo link_to('ultimo aggiornamento', 'atto/disegnoList?sort=stato_last_date&type='.($sf_user->getAttribute('type', 'asc', 'sf_admin/opp_atto/sort') == 'asc' ? 'asc' : 'desc'), array('class' => 'current '.$current_class)) ?>
      <?php else: ?>
        <?php echo link_to('ultimo aggiornamento', 'atto/disegnoList?sort=stato_last_date&type=desc') ?>
      <?php endif; ?>
    </li>
    <li>
      ...
      <?php else: ?>
        <?php echo link_to('interventi in Parlamento', 'atto/disegnoList?sort=n_interventi&type=desc') ?>
      <?php endif; ?>
    </li>
   <li>
      ...
      <?php else: ?>
        <?php echo link_to('utenti favorevoli', 'atto/disegnoList?sort=ut_fav&type=desc') ?>
      <?php endif; ?>
    </li>
    <li>
      ...
      <?php else: ?>
        <?php echo link_to('utenti contrari', 'atto/disegnoList?sort=ut_contr&type=desc') ?>
      <?php endif; ?>
    </li>
  </ul>
</div>