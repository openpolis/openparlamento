<li><p class="indent" style="margin-bottom: 0px;">tutti gli status [ <a href="#" class="btn-open action">apri</a> <a href="#" class="btn-close action" style="display:none;">chiudi</a> ]</p>
