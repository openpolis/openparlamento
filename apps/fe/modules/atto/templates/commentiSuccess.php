...
<div id="content" class="tabbed float-container">
  ...
  <div id="main">
    ...
    <p style="font-size:14px;">In questa pagina puoi lasciare commenti generali sull'atto.<br />
    Se invece vuoi <strong>annotare puntualamente i testi ufficiali</strong> dell'atto, vai alla sezione <?php echo link_to('"leggi i testi ufficiali dell\'atto e aggiungi le tue note"','/singolo_atto/'.$atto->getId().'#documenti') ?></p>
