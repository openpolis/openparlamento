...
<div id="disegni-decreti-order" class="float-container tools-container">
  ...
  <ul>
    <li>
      ...
      <?php else: ?>
        <?php echo link_to('data di emanazione', 'atto/decretoLegislativoList?sort=data_pres&type=desc') ?>
      <?php endif; ?>
    </li>
    <li>
      ...
      <?php else: ?>
        <?php echo link_to('utenti favorevoli', 'atto/decretoLegislativoList?sort=ut_fav&type=desc') ?>
      <?php endif; ?>
    </li>
    <li>
      ...
      <?php else: ?>
        <?php echo link_to('utenti contrari', 'atto/decretoLegislativoList?sort=ut_contr&type=desc') ?>
      <?php endif; ?>
    </li>
  </ul>
</div>