				...
				<tr class="even">
				  ...
				  <?php endif; ?>
				   <?php if ($vicino[1]->getTipoCaricaId()==4 || $vicino[1]->getTipoCaricaId()==5 ) : ?>
				    <?php echo "Sen. " ?>
				   <?php endif; ?>
				   <?php echo link_to($vicino[1]->getOppPolitico()->getNome()." ".$vicino[1]->getOppPolitico()->getCognome(),'@parlamentare?'.$vicino[1]->getOppPolitico()->getUrlParams()) ?>
			    ...
			    <h3 class="position-red" <?php echo ($sf_user->hasCredential('adhoc') ? ' style="width:40px;"' :'') ?> ><?php echo $pos+1 ?></h3>
			     ...
			     <?php endif; ?>
			      <?php if ($lontano[1]->getTipoCaricaId()==4 || $lontano[1]->getTipoCaricaId()==5 ) : ?>
			       <?php echo "Sen. " ?>
			      <?php endif; ?>
			     <?php echo link_to($lontano[1]->getOppPolitico()->getNome()." ".$lontano[1]->getOppPolitico()->getCognome(),'@parlamentare?'.$lontano[1]->getOppPolitico()->getUrlParams()) ?>
...
<?php if ($ambient=='home') : ?>
    ...
    <div class="row" style="border:1px solid #EE7F00;background-color:#F7F7F7; padding:5px;
      ...
      -moz-border-radius-topright:5px;">
        ...
        <div class="sixcol">
            <h5><span class="username">Ciao <span style="color:#EE7F00;"><?php echo $sf_user->getFirstname() ?></span>,
                <!-- cancella la riga sotto quando hai risolto il conteggio delle news-->
...
<?php if ($ambient=='politico' && array_key_exists($parlamentare->getId(),$posizione)) : ?>
  <div class="evidence-box float-container" style="margin-top:0; border:1px solid #EE7F00;">
       ...
       <span class="tools-container"><img alt="Ico-new" src="/images/ico-new.png" width="18" height="10"/></span>
       <span class="tools-container"><a class="ico-help" href="#">&nbsp;</a></span>
     	<div style="display: none;" class="help-box float-container">
     		<div class="inner float-container">
