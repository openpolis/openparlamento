<div style="color: #626262; font-family: Arial, Helvetica, sans-serif; font-size: 13px; text-align: center; margin-top: 20px">
    ...
    <?php if ($user->isAdhoc()): ?>
      <p style="font-size: 11px;"><strong>politicaldesk</strong> è un servizio di <a href="http://www.depp.it">depp srl</a> - Informazione e assistenza: servizi@depp.it, Tel. +39.0683608392</p>      
    <?php endif ?>
