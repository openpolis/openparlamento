...
class Text
{
  ...
  public static function denominazioneAtto($atto, $action='list')
  {
    switch($atto->getTipoAttoId())
    {
      ...
      case '2':
        if($atto->getRamo()=='C')
          $sub_str_pos = mb_strpos($atto->getDescrizione(),  'La Camera');
        else
          $sub_str_pos = mb_strpos($atto->getDescrizione(),  'Il Senato');
        
        $descrizione = mb_substr($atto->getDescrizione(), $sub_str_pos + 10 );
      ...
      default:
        ...
        $sub_str_pos = mb_strpos($atto->getDescrizione(),  'seduta n.');
  		  $sub_str1 = mb_substr($atto->getDescrizione(), $sub_str_pos + 10 );
  		  $sub_str_pos2 = mb_strpos($sub_str1,  '<br/>');
  		  $sub_str2 = mb_substr($sub_str1, $sub_str_pos2 + 5 );
