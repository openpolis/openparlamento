...
class sfSolrHighlighter
{
  ...
  public function __construct($content, $blacklist = null)
  {
    ...
    {
      throw new sfSolrHighterException('Word characters must be null or an array');
    }
    else
    {
  ...
  protected function prepare()
  {
    ...
    if (!$response)
    {
      throw new sfSolrHighlighterException('Highlighting failed because content is malformed X/HTML');
    }
