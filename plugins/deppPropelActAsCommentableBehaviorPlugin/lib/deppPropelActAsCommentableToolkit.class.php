...
/**
 * deppPropelActAsCommentable toolkit class
 *
 * @author   Guglielmo Celata <guglielmo@depp.it>
 * @author   Xavier Lacot <xavier@lacot.org>
 */
class deppPropelActAsCommentableToolkit
{
  /**
  ...
  static public function clean($text)
  {
    ...
    if ($use_htmlpurifier)
    {
      $htmlpurifier_path = sfConfig::get('app_deppPropelActAsCommentableBehaviorPlugin_htmlpurifier_path', 
