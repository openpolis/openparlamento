...
function updateFields(changedField, panelType, generatorRefresh) {
  ...
  var pos = document.getElementById('panel_pos') ?
                    document.getElementById('panel_pos').value : '0';                  
  ...
  if (panelType == 'syndicator')
  {
    ...
    frameHeight = (document.getElementById('panel_number').value * 53) + 100;
  }
  ...
  if (panelType == 'bill_status')
  {
    ...
    scriptName = "#HOSTNAMEjs/widget/widget_atto.js"; 
  }
  else if (panelType == 'issue_bills') {
  ...
  userCode = userCode.replace(/#POS/, pos);
